...
namespace SweetCakeShop
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Configure Stripe API key — chỉ dùng khi key hợp lệ (sk_test_ / sk_live_)
            var stripeSecret = StripeOptions.GetSecretKey(builder.Configuration);
            if (StripeOptions.IsConfigured(builder.Configuration))
            {

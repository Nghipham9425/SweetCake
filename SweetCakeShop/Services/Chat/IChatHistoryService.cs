...
namespace SweetCakeShop.Services.Chat
{
    public interface IChatHistoryService
    {
        ...
        Task<CustomerChatMessage> AddSystemMessageAsync(string content, CancellationToken ct = default);
        Task<bool> HasAnyMessagesAsync(CancellationToken ct = default);
        Task<bool> IsHumanSupportActiveAsync(CancellationToken ct = default);
